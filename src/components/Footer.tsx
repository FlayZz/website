  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-white/60 mb-6 max-w-md">
              ...
              7j/7 pour tous vos besoins en serrurerie. Devis gratuit.
            </p>
          ...
          {/* Services */}
          <div>
            <h4 className="text-lg font-semibold mb-4" style={{ color: '#d4a853' }}>Services</h4>
            <ul className="space-y-2 text-white/60">
              ...
              <li><Link href="#services" className="hover:text-white transition-colors">Installation</Link></li>
              <li><Link href="#services" className="hover:text-white transition-colors">Blindage</Link></li>
          ...
          {/* Contact */}
          <div>
            <h4 className="text-lg font-semibold mb-4" style={{ color: '#d4a853' }}>Contact</h4>
            <ul className="space-y-3 text-white/60">
              ...
              <li className="flex items-start gap-2">
                ...
                15 Rue de la Motte, 35000 Rennes
              </li>
            </ul>
          </div>
        </div>
        ...
        <div 
          className="mt-12 pt-8 text-center text-white/40 border-t"
